...
#ifndef SAPPHIRE_PLUGINS_TUBE_UNIT_TUBE_UNIT_H
#define SAPPHIRE_PLUGINS_TUBE_UNIT_TUBE_UNIT_H
#include <clap/clap.h>
...
static constexpr const char *pluginId{"org.sapphire_plugin.tube_unit"};
